...
Metaarchetech 公開知識站，基於 Quartz v4 架設，部署於 GitHub Pages。Vault 內容（Obsidian Markdown）直接發布為可搜尋的靜態網站，支援 Graph View、全文搜尋（BM25）、CJK 中文分詞。
...
- GitHub：[metaarchetech/metaarchetech.github.io](https://github.com/metaarchetech/metaarchetech.github.io)
