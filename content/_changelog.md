...
### Templates Added
- `00 System/Templates/Research_Lead_Agent.md` — lead-agent prompt template from anthropic-cookbook
- `00 System/Templates/Research_Subagent.md` — subagent prompt template from anthropic-cookbook

### Skills Added
- `05 Claude Skills/research-orchestrator/SKILL.md` — multi-agent research orchestration (anthropic-cookbook)
- `05 Claude Skills/pr-review-expert/SKILL.md` — structured PR code review (claude-skills/engineering)
- `05 Claude Skills/spec-driven-workflow/SKILL.md` — spec-first development (claude-skills/engineering)
- `05 Claude Skills/rag-architect/SKILL.md` — RAG pipeline design & optimization (claude-skills/engineering)

### Knowledge Notes Added
- `04 Knowledge/RAG_Patterns/contextual-embeddings.md` — contextual embeddings for RAG improvement
...
### Files Updated
- `00 System/Templates/Research_Lead_Agent.md` — 中文摘要 added (multi-agent research lead role)
- `00 System/Templates/Research_Subagent.md` — 中文摘要 added (research execution agent)
- `05 Claude Skills/research-orchestrator/SKILL.md` — 中文摘要 added (multi-agent orchestration)
- `05 Claude Skills/pr-review-expert/SKILL.md` — 中文摘要 added (structured code review)
- `05 Claude Skills/spec-driven-workflow/SKILL.md` — 中文摘要 added (spec-first development)
- `05 Claude Skills/rag-architect/SKILL.md` — 中文摘要 added (RAG pipeline design)
- `04 Knowledge/RAG_Patterns/contextual-embeddings.md` — 中文摘要 added (contextual embedding optimization)
