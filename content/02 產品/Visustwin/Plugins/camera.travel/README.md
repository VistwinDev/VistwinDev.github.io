---
tags: [VisTwin, omniverse, extension, presentation, camera]
created: 2026-04-14
...
[[VisTwin OSC Controller]] 的 `/camera/<name>` 即是呼叫此 API。
...
async def _fly_async(target_path: str, duration_frames: int, on_done=None):
    ...
    for frame in range(duration_frames):
        t = _smooth(frame / duration_frames)
...
← [[02 產品/VisTwin/Plugins/README|VisTwin Plugins]]
