---
tags: [moc, ontology, VisTwin, knowledge-graph]
created: 2026-04-17
updated: 2026-04-17
---
...
這套筆記從「產業全景」走到「VisTwin 具體決策」,建議第一次讀按順序看完。熟了以後可以當工具書,挑需要的章節跳讀。
...
5. [[04 Canonical Format 選型]] — LinkML / Pydantic / JSON Schema / OWL,為什麼 VisTwin 選 Pydantic
6. [[05 VisTwin T-Box v1 類別清單]] — 最終落地的類別階層與欄位
...
知識筆記穩定後,實作落地在 `D:\Visustwin\ontology\`(尚未建立),結構參見 [[05 VisTwin T-Box v1 類別清單]] 最後一節。

---

## 📝 相關連結

- [[Semantor 設計概念]] — VisTwin 自創詞「語意操作節點」,Ontology 是它的底層字典
- [[VisTwin]] — 平台總覽
