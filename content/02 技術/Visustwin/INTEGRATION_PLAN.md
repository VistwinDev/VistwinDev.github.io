---
tags: [VisTwin, integration, kit-web, phase-2, proposal]
aliases: ["VisTwin Integration Plan", "Kit-Web Integration Phase 2"]
created: 2026-04-23
updated: 2026-04-23
status: proposal
draft: true
...
# VisTwin — Kit ↔ Web Integration Plan (Phase 2)
...
- **Production** on VisTwin's domain (e.g. `studio.metaarchetech.com`) — same build, same default to `demo` mode unless the visitor is inside the office VPN and env-flagged to attempt the local bridge. The production build is a pure showcase; it is not expected to talk to any real Kit.
...
| Internal demo | VisTwin | `internal` (all gates bypassable) | `studio.metaarchetech.com` | local or relay |
...
- Tier source: [[01 專案/VisTwin/Omniverse Web化 分類清單|Omniverse Web化 分類清單]] (vault)

---

## 相關筆記 (Vault cross-refs)

- 分類依據：[[01 專案/VisTwin/Omniverse Web化 分類清單|Omniverse Web化 分類清單]]
- 評估總覽：[[01 專案/VisTwin/Omniverse Web化 評估|Omniverse Web化 評估]]
- 上游幾何整併：[[01 專案/VisTwin/Omniverse Web化/Web化 Massing Pipeline|Web化 Massing Pipeline]]
- 下游整併提案：[[01 專案/VisTwin/Omniverse Web化/Web化 整併提案|Web化 整併提案]]
- 架構選項比較：[[01 專案/VisTwin/Omniverse Web化/Web化 架構選項|Web化 架構選項]]
- Web repo：[[01 專案/VisTwin/Repos/visustwin-showcase|visustwin-showcase]]
- Kit repo：[[01 專案/VisTwin/Repos/Omniverse-Extensions|Omniverse-Extensions]]
- 核心 Kit ext：[[01 專案/VisTwin/Omniverse Web化/visustwin.dashboard|visustwin.dashboard]] · [[01 專案/VisTwin/Omniverse Web化/visustwin.warp.windtunnel|visustwin.warp.windtunnel]] · [[01 專案/VisTwin/Omniverse Web化/visustwin.solar.heatmap|visustwin.solar.heatmap]] · [[01 專案/VisTwin/Omniverse Web化/visustwin.sunlight.studio|visustwin.sunlight.studio]] · [[01 專案/VisTwin/Omniverse Web化/visustwin.bim.inspector|visustwin.bim.inspector]] · [[01 專案/VisTwin/Omniverse Web化/visustwin.vision.detector|visustwin.vision.detector]]

---

← [[01 專案/VisTwin/MOC|VisTwin MOC]]
