...
- **拉今日 Google Calendar 事件** → 更新 `01 專案/Projects Dashboard.md` 的 gantt 區塊
...
甘特圖統一放在 `01 專案/Projects Dashboard.md`,用 Obsidian 原生 Mermaid `gantt` block 渲染,不需要任何第三方 plugin。
