...
---
tags: [ontology, t-box, classes, VisTwin, implementation]
created: 2026-04-17
updated: 2026-04-17
---

# 📚 VisTwin T-Box v1 類別清單
...
- **Aligns with:** 無直接對應 (VisTwin 獨有;IFC 有 `IfcSpatialZone` 但不緊貼)
...
## 🏠 Showcase 分支 (VisTwin 獨有)

### SampleHome

- **Aligns with:** 無 (VisTwin 獨有)
...
```
D:\VisTwin\ontology\visustwin_ontology\
