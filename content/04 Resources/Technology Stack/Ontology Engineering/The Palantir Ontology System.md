---
tags: [resources, tech, palantir, ontology, aip, architecture]
created: 2026-04-16
source: Palantir AIP Software Demonstration — Chad Wahlquist (FWD Deployed Architect)
---
...
## 對 [[Visustwin Extensions]] 的意義

Visustwin 可以延伸這三層，**並加上 Palantir 沒有的第四層**：

| Palantir 層 | Visustwin 對應 |
|---|---|
...
**關鍵差異**：每個 Visustwin Object 有「**USD Prim 綁定**」這個維度，意味著每個 Object 都有空間對應。這是 Palantir Ontology 結構上做不到的。

---

## 相關筆記

- [[Ontology Engineering]] — 本主題 MOC
- [[Foundation Model Distillation Ontology Mapping]] — 異質 Ontology 對齊
- [[Langchain 平台 MCP 化]] — LLM × 工具整合實踐
- [[Model Context Protocol]] — Anthropic 的 tool protocol（概念上類似 Ontology schema）
- [[2025 Vibe Coding & Multi Agent]] — Agent 時代的工程實踐
...
- 演講者 Chad Wahlquist（Palantir FWD Deployed Architect）

## 返回

- [[Ontology Engineering]] → [[Technology Stack MOC]] → [[Vault Home]]
