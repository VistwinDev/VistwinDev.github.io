...
- 左下:網址 `vistwin.com ↗`(裸網域 + 造訪箭頭,不用 www/https)在最上,其下為
  tagline `數位孿生 × BIM × 人工智能部署` + HUD `Digital twin × BIM × AI deployment`
  (三概念各自獨立;數位孿生領頭扣品牌、BIM 獨立當熟悉錨、人工智能部署壓軸)
- 右下:一小截**綠色刻度 tick**(16px,對齊 tagline 行)—— 綠的第三個觸點(括號 / 點 / tick),
  僅正面有、背面不放;此為綠的天花板,勿再加
