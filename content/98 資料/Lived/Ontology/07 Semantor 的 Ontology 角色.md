...
---
tags: [ontology, semantor, VisTwin, architecture]
created: 2026-04-17
updated: 2026-04-17
---
...
> Vault 既有筆記 [[Semantor 設計概念]] 把 Semantor 定位為 VisTwin 的「**語意操作節點**」。本篇接上去:Semantor 與 Ontology 是什麼分工、誰依賴誰、訊號怎麼流。
...
照原筆記「施工現場相機擷取 → Semantor 發現一人未穿反光背心」的案例,在 VisTwin 樣品屋改寫成「工作區域閒人誤入」:
...
- 呼叫 LLM:「這個 label 在 VisTwin ontology 下最接近哪個類別?」
...
- [[05 VisTwin T-Box v1 類別清單]] — Semantor 會查的類別
