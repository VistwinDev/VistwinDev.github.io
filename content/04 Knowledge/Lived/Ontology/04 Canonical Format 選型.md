...
---
tags: [ontology, format, pydantic, linkml, json-schema, owl, visustwin]
created: 2026-04-17
updated: 2026-04-17
---
...
> 「用什麼語言寫 ontology?」這問題沒有唯一答案。取捨要看團隊、使用場景、外部交換需求。這篇比較主流選項,並記錄 VisusTwin 為什麼選 **Pydantic**。
...
prefixes:
  ...
  visustwin: https://visustwin.com/ns/
...
└── *.py                 ← SOURCE OF TRUTH (Pydantic)
        ↓
     (Python import)     Omniverse extensions (visustwin.*)
        ↓
   model_json_schema()
        ↓
...
- [[05 VisusTwin T-Box v1 類別清單]] — 實際 Pydantic 程式碼會長什麼樣
