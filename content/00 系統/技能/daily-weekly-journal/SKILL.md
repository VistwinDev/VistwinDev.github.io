...
（`02 技術/Visustwin/sprints/`），讓 Obsidian + Quartz 站點看得到開發節
...
| Sprint 慣例 | `02 技術/Visustwin/sprints/README.md` | 依此 ISO 週命名 |
| Daily 落點 | `02 技術/Visustwin/sprints/2026-W{NN}/YYYY-MM-DD.md` | 寫這裡 |
| Weekly 落點 | `02 技術/Visustwin/sprints/2026-W{NN}/retro.md` 或 `Weekly Review · YYYY-MM-DD.md` 同資料夾 | 寫這裡 |
...
2. 讀 [[working-with-frncs/SKILL|working-with-frncs]] §0–§11（特別 §2 不開戰場、
   §8 事實先於擔憂、§7 真實價值＝進度）。
3. 讀 `02 技術/Visustwin/sprints/README.md` 確認 scrum 慣例沒變。
...
1. ISO 週 → sprint 資料夾 `02 技術/Visustwin/sprints/2026-W{NN}/`；
...
2. **抓真實活動**（有什麼抓什麼，沒有就誠實留空，不要編）：
   ...
   - `00 系統/技能/_changelog.md` 今天那段（新 / 改 skill）
