...
| 4 | [vistwin-plugins-web](https://github.com/metaarchetech/vistwin-plugins-web) | private | **active** | Visustwin plugin Web demo / Studio Shell | 2026-05-01 |
...
| 9 | [vistwinsite](https://github.com/metaarchetech/vistwinsite) | **public** | held | Visustwin 站點(Web) | 2026-04-22 |
...
- **入口**:[[index|🏠 vault home]] · [[Now]] · [[02 Products/Visustwin/README|Visustwin]]
...
- **入口**:[[02 Products/Visustwin/Plugins/README|Plugins MOC]] · [[02 Products/Visustwin/Plugins/code-review-2026-04-30|code review 2026-04-30]]
...
### 3. vistwin-plugins-web — Visustwin plugin Web demo / Studio Shell
...
- **入口**:[[02 Products/Design-System/showcase-ui-inventory|showcase UI inventory]] · [[02 Products/Design-System/frontend-stack-matrix|frontend stack matrix]]
...
- **入口**:[[02 Products/Design-System/showcase-ui-inventory|UI inventory]] · [[02 Products/Design-System/frontend-stack-matrix|stack matrix]] · [[02 Products/Design-System/README|Design-System MOC]]
...
- **入口**:[[01 Projects/visionbase/visionbase-monitor|monitor 專案頁]] · [[01 Projects/visionbase/network-inventory|network inventory]] · [[01 Projects/visionbase/kuka-control-feasibility|KUKA recon]] · [[01 Projects/visionbase/README|visionbase MOC]]
...
- **用途**:AI safety monitoring — YOLO + WebSocket + MJPEG streaming server for Visustwin
- **狀態**:跟 `visustwin.vision.detector` plugin(在 `visustwin-extensions`)互補:此 repo 是後端 streaming server,plugin 是 Kit 端 viewer。
- **關係**:[[02 Products/Visustwin/Plugins/README|Plugins MOC]] 中 vision.detector 的 server side。

### 9. vistwinsite
- **Visibility**:**public** · branch `master`
- **用途**:Visustwin 站點(舊架構推測)
...
## C. 上游 Fork — 未在 metaarchetech 帳號下,但本地深度開發
...
- **本地修改**:`.gitignore` 排除 `/source/`,所有 visustwin.* plugins 開發都在 `source/extensions/`,push 到 `visustwin-extensions` mirror 而非 fork。
...
### 設計系統 / 前端
- [[02 Products/Design-System/showcase-ui-inventory]] — showcase + plugins-web 的元件清單(741 行)
- [[02 Products/Design-System/frontend-stack-matrix]] — 前端棧 matrix
- [[02 Products/Design-System/README|Design-System MOC]]

### Visustwin 產品
- [[02 Products/Visustwin/README|Visustwin 產品頁]]
- [[02 Products/Visustwin/Plugins/README|Plugins MOC]]
- [[02 Products/Visustwin/Plugins/code-review-2026-04-30]] — 26-file audit(3 High / 9 Medium / ~30 Low)
- [[02 Products/Visustwin/Plugins/ventilation.report/architecture-research]] — 換氣分析架構研究

### Visionbase(客戶)
- [[01 Projects/visionbase/README|visionbase MOC]]
- [[01 Projects/visionbase/visionbase-monitor]] — 監控站專案頁
- [[01 Projects/visionbase/network-inventory]] — 區網盤點
- [[01 Projects/visionbase/kuka-control-feasibility]] — KUKA robot recon
