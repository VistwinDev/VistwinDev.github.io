---
tags: [VisTwin, omniverse, extension, simulation, solar, illuminance]
created: 2026-04-14
...
在 USD Stage 中繪製太陽軌跡弧線與 36 方向照度玫瑰圖，可接收 [[VisTwin MQTT Bridge]] 廣播的即時感測器照度（lux）數據。
...
`omni.usd`, `omni.kit.uiapp` (subscribes [[VisTwin MQTT Bridge]] events)

---

← [[VisTwin Extensions MOC]]
