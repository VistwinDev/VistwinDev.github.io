...
實踐大學 visionbase 實驗室。metaarchetech 的學校合作單位,2026-04-29 起進駐並開始建置區網盤點與監控站。
...
掃描範圍 `192.168.0.0/24`,共識別 **34 台裝置 / 29 在線**。完整清單見 [[01 Projects/visionbase/network-inventory|network-inventory]]。
...
- **開發機**:metaarchetech 公司端 Windows(`C:` 槽為主開發,`D:` 槽在另一台機器)
- **部署目標**:裝置監控網站跑在開發機(`192.168.0.220:3000`),長期可能搬到 Synology NAS 或專用 mini PC

## 子文件

- [[01 Projects/visionbase/visionbase-monitor|visionbase-monitor]] — 今天開發的監控網站
- [[01 Projects/visionbase/network-inventory|network-inventory]] — 34 台裝置詳細清單
- [[01 Projects/visionbase/kuka-control-feasibility|kuka-control-feasibility]] — KUKA 監控 / 控制可行性研究

## 相關產品

- [[02 Products/Visustwin/README|Visustwin]] — Omniverse 物理空間數位孿生(visionbase 是物理基地)

## 返回

- [[01 Projects/CLAUDE|01 Projects]]
