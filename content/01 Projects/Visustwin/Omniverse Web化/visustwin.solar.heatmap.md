...
lat   = settings.get_as_float("/visustwin/sunlight/lat")   # 25.033
lon   = settings.get_as_float("/visustwin/sunlight/lon")   # 121.565
hour  = settings.get_as_float("/visustwin/sunlight/hour")  # 12.0
