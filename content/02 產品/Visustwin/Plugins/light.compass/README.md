...
在 USD Stage 中繪製太陽軌跡弧線與 36 方向照度玫瑰圖,接收 [[02 產品/VisTwin/Plugins/mqtt.bridge/README|mqtt.bridge]] 廣播的即時感測器照度(lux)。
...
- `omni.usd`
- `omni.kit.uiapp`
- 訂閱 [[02 產品/VisTwin/Plugins/mqtt.bridge/README|mqtt.bridge]] 的 events

## 跟 SUN 系列的關係

| Ext | 角色 | 跟 light.compass 重疊處 |
|---|---|---|
| [[02 產品/VisTwin/Plugins/sunlight.studio/README|sunlight.studio]] | 全域陽光控制(NOAA + 城市庫) | 太陽位置計算(已用 NOAA 取代) |
| [[02 產品/VisTwin/Plugins/solar.heatmap/README|solar.heatmap]] | 每戶得熱熱圖 | 跟玫瑰圖在概念上重疊 |
| [[02 產品/VisTwin/Plugins/solar.report/README|solar.report]] | matplotlib 報告 | 數值化呈現,跟玫瑰圖互補 |
